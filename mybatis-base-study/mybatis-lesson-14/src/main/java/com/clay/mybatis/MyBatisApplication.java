...
public class MyBatisApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// insert
			Department department = new Department(1L, "开发部门");
			Employee newEmployee = new Employee("Tom", "1", "tom@gmail.com", department);
			mapper.addEmp(newEmployee);

			// select
			Employee employee = mapper.getEmpAndDept(newEmployee.getId());
