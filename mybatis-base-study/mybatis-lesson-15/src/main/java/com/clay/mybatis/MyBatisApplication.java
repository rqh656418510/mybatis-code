...
public class MyBatisApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// select
			List<Employee> employeeList2 = mapper.getEmpsByConditionTrim(employee);
			System.out.println(employeeList2);

			// select
			List<Employee> employeeList3 = mapper.getEmpsByConditionChoose(employee);
			System.out.println(employeeList3);

			// update
			Employee employee2 = new Employee();
			employee2.setId(1L);
			employee2.setEmail("jim@qq.com");
			mapper.updateEmp(employee2);

			// select
			List<Long> ids = Arrays.asList(1L, 2L);
			List<Employee> employeeList4 = mapper.getEmpsByConditionByForeach(ids);
			System.out.println(employeeList4);

			// insert
			Employee employee3 = new Employee("John", "1", "john@gmail.com");
			Employee employee4 = new Employee("David", "1", "david@gmail.com");
			mapper.addEmps(Arrays.asList(employee3, employee4));
			mapper.addEmps2(Arrays.asList(employee3, employee4));
